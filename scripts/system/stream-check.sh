...
clear;
echo -e "  \033[1;37m${Font_Purple}Media Stream Unlocker Test Mod By risqinf${Font_Suffix}\033[0m";
...
function InstallCurl() {
    if [ -e "/etc/redhat-release" ];then
        ...
        echo -e "${Font_Red}Please install curl manually${Font_Suffix}";
        exit;
    fi
}
